...
//middleware
app.use(express.static(path.join(__dirname +"/develop/public"))); //using express.static and app.use to pull all the files from the public folder to use mostly from the css styling. 
